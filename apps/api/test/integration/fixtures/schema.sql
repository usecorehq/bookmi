...
--> statement-breakpoint
CREATE UNIQUE INDEX "pc_reference_uniq" ON "bookmi"."paycodes" USING btree ("paycode_reference");
--> statement-breakpoint
...
ALTER TABLE "bookmi"."bookings" ADD COLUMN "refunded_at" timestamp with time zone;--> statement-breakpoint
